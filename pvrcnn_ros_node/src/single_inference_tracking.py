...
class Processor_ROS:
    ...
    def read_config(self):
        ...
        # ROS stuff
        self.sub = rospy.Subscriber("/middleVLP32C/velodyne_points", PointCloud2, self.lidar_callback, queue_size=1, buff_size=2**24)
    ...
    def run_detection_tracking(self, points):
        t_t = time.time()
